    ...
    stages {
        stage('git pull & compile') {
            steps {
                ...
                sh "/opt/maven/apache-maven-3.8.1/bin/mvn sonar:sonar -Dsonar.projectKey=my-project-1 -Dsonar.host.url=http://15.206.208.184:9000 -Dsonar.login=baaed209d3a9a2828f7748988cca14d0dc55ceac"
            }
        }
